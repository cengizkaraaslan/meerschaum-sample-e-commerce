  ...
  if (!e.TweenLite) {
          ...
          if (0 === d && n)
            for (
              _ = ("com.greensock." + i).split("."),
                u = _.pop(),
                m = o(_.join("."))[u] = this.gsClass = n.apply(n, a),
                r &&
                  ((e[u] = m),
    ...
    var v = [0, 0, 1, 1],
      ...
      w = (T.register = function(t, e, i, s) {
        for (
          ...
          for (
            r = h[_],
              n = s ? d("easing." + r, null, !0) : l.easing[r] || {},
              a = u.length;
            --a > -1;

          )
            (o = u[a]),
              (y[r + "." + o] = y[o + r] = n[o] = t.getRatio
                ? t
                : t[o] || new t());
      });
    for (
      ...
      (n = i[s] + ",Power" + s),
        w(new T(null, null, 1, s), n, "easeOut", !0),
        w(new T(null, null, 2, s), n, "easeIn" + (0 === s ? ",easeNone" : "")),
        w(new T(null, null, 3, s), n, "easeInOut");
    (y.linear = l.easing.Linear.easeIn), (y.swing = l.easing.Quad.easeInOut);
    var P = d("events.EventDispatcher", function(t) {
      (this._listeners = {}), (this._eventTarget = t || this);
    });
    (n = P.prototype),
      (n.addEventListener = function(t, e, i, s, n) {
        n = n || 0;
        var o,
          l,
          h = this._listeners[t],
      ...
      var i,
        ...
        d = function(t) {
          ...
          a > p && (m += a - c),
            ...
            (e = _.time - l),
            (!i || e > 0 || t === !0) &&
              (_.frame++, (l += e + (e >= o ? 0.004 : o - e)), (r = !0)),
            t !== !0 && (n = s(d)),
            r && _.dispatchEvent("tick");
        };
      P.call(_),
        (_.time = _.frame = 0),
        (_.tick = function() {
        ...
        (_.sleep = function() {
          null != n &&
            (f && b ? b(n) : clearTimeout(n),
            (s = u),
            (n = null),
            _ === r && (a = !1));
        }),
        (_.wake = function() {
          null !== n ? _.sleep() : _.frame > 10 && (S = A() - p + 5),
            (s =
              0 === i
                ? u
                : f && k
                ...
                r
                  ? "string" != typeof r
                    ? r.length &&
                      ...
                      ? (a.splice(n--, 1),
                        (this._targets = a = a.concat(_.call(r, 0))))
                      : ((this._siblings[n] = M(r, this, !1)),
                        1 === l &&
                          this._siblings[n].length > 1 &&
                          $(r, this, null, 1, this._siblings[n]))
                    : ((r = a[n--] = D.selector(r)),
                      "string" == typeof r && a.splice(n + 1, 1))
                  : a.splice(n--, 1);
          else
            (this._propLookup = {}),
              (this._siblings = M(e, this, !1)),
              1 === l &&
    ...
    var z = [],
      ...
      q = function() {
        ...
        for (O = {}; --t > -1; )
          (i = z[t]),
            i && i._lazy !== !1 && (i.render(i._lazy, !1, !0), (i._lazy = !1));
        z.length = 0;
      };
    (B._startTime = r.time),
      (Q._startTime = r.frame),
      (B._active = Q._active = !0),
      setTimeout(q, 1),
      (x._updateRoot = D.render = function() {
        var t, e, i;
        if (
          (z.length && q(),
          B.render((r.time - B._startTime) * B._timeScale, !1, !1),
          Q.render((r.frame - Q._startTime) * Q._timeScale, !1, !1),
          z.length && q(),
          !(r.frame % 120))
        ) {
          for (i in U) {
      ...
      K = function(t, e, i) {
        ...
        return (
          ...
          r > e
            ...
            ? h
            : (r += t.totalDuration() / t._timeScale / n) > e + h
            ? 0
            : r - e - h
        );
      };
      ...
      (n._initProps = function(e, i, s, n) {
        ...
        for (r in this.vars) {
          if (((_ = this.vars[r]), j[r]))
            ...
            L[r] &&
            (l = new L[r]())._onInitTween(e, this.vars[r], this)
          ) {
            for (
              this._firstPT = h = {
                _next: this._firstPT,
        ...
        if (t >= l)
          (this._totalTime = this._time = l),
            ...
            0 === l &&
              ...
              (0 === t || 0 > _ || _ === h) &&
                _ !== t &&
                ((i = !0), _ > h && (n = "onReverseComplete")),
              (this._rawPrevTime = a = !e || t || _ === t ? t : h));
        else if (1e-7 > t)
    ...
    if (
      ...
      (H.API = 2),
      (n._firstPT = null),
      (n._addTween = function(t, e, i, s, n, r) {
        var a, o;
        return null != s &&
          (a =
      ...
      var h,
        ...
        Y = (function() {
          ...
          return (
            ...
            (p = f && 6 > Number(F.substr(F.indexOf("Version/") + 8, 1))),
            (_ = -1 !== F.indexOf("Firefox")),
      ...
      var he = function(t, e, i, r) {
        ...
        (E.CSSPropTween = function(t, e, r, s, a, o, l, h, u, f, _) {
          (this.t = t),
            ...
            u && ((this.pr = u), (i = !0)),
            (this.b = void 0 === f ? r : f),
            (this.e = void 0 === _ ? r + s : _),
            a && ((this._next = a), (a._prev = this));
        })),
        pe = (a.parseComplex = function(t, e, i, r, s, n, a, o, l, u) {
          (i = i || n || ""),
            (a = new _e(t, e, 0, 0, a, u ? 2 : 1, null, !1, o, i, r)),
            (r += "");
          var f,
            _,
            p,
          ...
          for (
            (-1 !== r.indexOf(",") || -1 !== i.indexOf(",")) &&
              ...
              (R = R.join(" ")
                ...
                .split(" ")),
              (k = C.length)),
              k !== R.length && ((C = (n || "").split(" ")), (k = C.length)),
              a.plugin = l,
              a.setRatio = u,
              f = 0;
            k > f;
      ...
      var ve = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective".split(
        ...
        Pe = (E.getTransform = function(t, e, i, r) {
          ...
          var s,
            ...
            b = x * M,
            P = xe
              ? parseFloat(q(t, we, e, !1, "0 0 0").split(" ")[2]) ||
                v.zOrigin ||
                0
              : 0;
          for (
          ...
          if (16 === n.length) {
            ...
            if (
              ...
              (v.rotationX = G * L),
                ...
                (v.scaleX = (0 | (Math.sqrt(B * B + U * U) * w + 0.5)) / w),
                (v.scaleY = (0 | (Math.sqrt(H * H + C * C) * w + 0.5)) / w),
            ...
            (v.x = n[4] || 0),
              ...
              (_ = te || ee ? Math.atan2(ee, te) * L : v.rotation || 0),
              (p = ie || re ? Math.atan2(ie, re) * L + _ : v.skewX || 0),
        ...
        Ce = (E.set3DTransformRatio = function(t) {
          ...
          (f = 1),
            ...
            1 !== A && ((i *= A), (a *= A), (u *= A), (d *= A)),
            1 !== k && ((e *= k), (n *= k), (h *= k), (c *= k)),
            g && ((p -= g), (s = r * p), (l = o * p), (p = f * p + g)),
            (s = (w = (s += S.x) - (s |= 0))
              ? (0 | (w * v + (0 > w ? -0.5 : 0.5))) / v + s
              : s),
            (l = (w = (l += S.y) - (l |= 0))
              ? (0 | (w * v + (0 > w ? -0.5 : 0.5))) / v + l
              : l),
            (p = (w = (p += S.z) - (p |= 0))
        ...
        Re = (E.set2DTransformRatio = function(t) {
          ...
          return a.rotationX ||
            ...
            ? ((this.setRatio = Ce), Ce.call(this, t), void 0)
            : (a.rotation || a.skewX
                ? ((e = a.rotation * M),
                  (i = e - a.skewX * M),
                  (r = 1e5),
      ...
      me(
        "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType",
        {
          parser: function(t, e, i, r, n, o, l) {
            ...
            for (
              xe && null != T.force3D && ((m.force3D = T.force3D), (c = !0)),
                ...
                (ye
                  ? ((c = !0),
                    ...
                    xe
                      ...
                      : (n.xs0 = n.e = _))
                  : ee(_ + "", m)),
              c && (r._transformType = p || 3 === this._transformType ? 3 : 2),
              n
            );
          },
          prefix: !0
              ...
              this.p.indexOf("border") && (b[l] = V(b[l])),
                ...
                y
                  ? ((c = parseInt(_.charAt(0) + "1", 10)),
                    (_ = _.substr(2)),
                    (c *= parseFloat(_)),
                    (g = _.substr((c + "").length - (0 > c ? 1 : 0)) || ""))
                  : ((c = parseFloat(_)), (g = _.substr((c + "").length))),
                "" === g && (g = r[i] || v),
                g !== v &&
                  ((T = Q(t, "borderLeft", p, v)),
                  (w = Q(t, "borderTop", p, v)),
                  "%" === g
                    ? ((f = 100 * (T / d) + "%"), (u = 100 * (w / m) + "%"))
                    : "em" === g
                    ...
                    : ((f = T + "px"), (u = w + "px")),
                  y &&
                    ((_ = parseFloat(f) + c + g), (h = parseFloat(u) + c + g))),
                (a = pe(P, b[l], f + " " + u, _ + " " + h, !1, "0px", a));
            return a;
          },
          prefix: !0,
        ...
        me("backgroundPosition", {
          ...
          parser: function(t, e, i, r, n, a) {
            ...
            if (
              ...
              ((_ = q(t, "backgroundImage").replace(C, "")), _ && "none" !== _)
            ) {
              for (
                o = m.split(" "),
                  l = g.split(" "),
                  I.setAttribute("src", _),
                  h = 2;
                --h > -1;
        ...
        (l._onInitTween = function(t, e, o) {
          ...
          if (
            (u &&
              "" === x.zIndex &&
              ((l = q(t, "zIndex", s)),
              ("auto" === l || "" === l) && this._addLazySet(x, "zIndex", 0)),
            "string" == typeof e &&
              ((d = x.cssText),
              (l = $(t, s)),
              (x.cssText = d + ";" + e),
              (l = G(t, l, $(t)).difs),
              !Y && w.test(e) && (l.opacity = parseFloat(RegExp.$1)),
              (e = l),
              (x.cssText = d)),
          ...
          if (i) {
            for (; _; ) {
              ...
              (_._prev = c ? c._prev : m) ? (_._prev._next = _) : (d = _),
                (_._next = c) ? (c._prev = _) : (m = _),
                (_ = g);
            }
            this._firstPT = d;
          }
                  ...
                  (m && b.test(p))
                    ? (m ||
                        ...
                        (p =
                          ...
                          p.join(",") +
                          ")")),
                      (i = pe(v, a, _, p, !0, "transparent", i, 0, n)))
                    : !m || (-1 === p.indexOf(" ") && -1 === p.indexOf(","))
                    ? ((u = parseFloat(_)),
                      (c = u || 0 === u ? _.substr((u + "").length) : ""),
                      ("" === _ || "auto" === _) &&
                        ("width" === a || "height" === a
                          ? ((u = te(t, a, s)), (c = "px"))
                          : "left" === a || "top" === a
                      ...
                      g
                        ? ((f = parseInt(p.charAt(0) + "1", 10)),
                          ...
                          (d = p.replace(y, "")))
                        : ((f = parseFloat(p)),
                          (d = m ? p.substr((f + "").length) || "" : "")),
                      "" === d && (d = a in r ? r[a] : c),
                      (p = f || 0 === f ? (g ? f + u : f) + d : e[a]),
                      c !== d &&
                        "" !== d &&
                        (f || 0 === f) &&
                        u &&
