!(function(a) {
  ...
  var b = {
    ...
    init: function() {
      if (!this.initialised) {
        ...
        "function" == typeof imagesLoaded &&
          imagesLoaded(a.container, function() {
    ...
    getNavContainerHeight: function() {
      a(window).width() > 768 &&
        (this.navContainerHeight = a("#main-nav-container").outerHeight());
    },
    fixNavContainerHeight: function() {
      a(window).width() <= 768 &&
        a(".fixed-wrapper").length &&
        a(".fixed-wrapper").css("height", "auto");
    },
    stickyMenu: function() {
      var b = this,
      ...
      c >= g && c > h && d > 768
        ? (f.closest(".fixed-wrapper").length ||
            f.wrap(function() {
              return (
                '<div class="fixed-wrapper" style="height:' +
                b.navContainerHeight +
                'px"></div>'
              );
            }),
          f.addClass("fixed"))
    ...
    responsiveMenu: function() {
      ...
      c.append(b),
        c.find("li, .col-2, .col-3, .col-4, .col-5").each(function() {
          var b = a(this);
          b.hasClass("mega-menu-container") &&
    ...
    itemAnimationIn: function() {
      ...
      220 > d &&
        c.animate({ width: "hide" }, 100, function() {
          a(this)
            .closest(".item-add-btn")
            .addClass("icon-cart");
        }),
        e.animate({ width: "show" }, 300),
        f
          .css({
            visibility: "visible",
            overflow: "hidden",
    ...
    itemHoverAnimation: function() {
      var b = this;
      a.fn.hoverIntent
        ? a(".item-hover").hoverIntent(b.itemAnimationIn, b.itemAnimationOut)
        : a(".item-hover")
            .on("mouseover", b.itemAnimationIn)
            .on("mouseleave", b.itemAnimationOut);
    },
    itemSizeFix: function() {
      ...
      c.each(function() {
        var b = a(this);
        b.hasClass("item-hover") ||
          b.closest(".carousel-inner").length ||
          (b.width() < 220
            ? (b.find(".icon-cart-text").fadeOut(20, function() {
                a(this)
                  .closest(".item-add-btn")
                  .addClass("icon-cart");
              }),
              ...
              b.find(".item-action").css("text-align", "center"))
            : (b
                .find(".icon-cart-text")
                .fadeIn(10)
                .closest(".item-add-btn")
      ...
      a("#quick-search").on("click", function(c) {
        ...
        if ("" === g) {
          var h = e.find(":hidden.form-group"),
            i = e.find(".form-group ");
          b
            ? h.animate({ width: "show" }, 400, function() {
                b = !1;
              })
    ...
    twitterFeed: function() {
      a.fn.tweet &&
        a(".twitter_feed").length &&
        (a(".twitter_feed").tweet({
          modpath: "./js/twitter/",
          avatar_size: "",
          count: 4,
          query: "themeforest",
        ...
        a.fn.tweet &&
          a(".twitter_feed_widget").length &&
          a(".twitter_feed_widget").tweet({
            modpath: "./js/twitter/",
            avatar_size: "",
            count: 2,
            query: "themeforest",
    ...
    productZoomImage: function() {
      ...
      a.fn.elastislide &&
        c.elastislide({ orientation: "vertical", minItems: 4 }),
        a.fn.elevateZoom &&
          (a("#product-image").elevateZoom({
            responsive: !0,
    ...
    owlCarousels: function() {
      ...
      b.checkSupport(c, a.fn.owlCarousel) &&
        c
          .owlCarousel({
            items: 6,
            itemsDesktop: [1199, 5],
      ...
      b.checkSupport(d, a.fn.owlCarousel) &&
        d
          .owlCarousel({
            items: 4,
            itemsDesktop: [1199, 4],
          ...
          .data("navigationBtns", [
            "#hot-items-slider-prev",
            "#hot-items-slider-next"
          ]);
      var e = a(".latest-items-slider.owl-carousel");
      b.checkSupport(e, a.fn.owlCarousel) &&
        e
          .owlCarousel({
            items: 4,
            itemsDesktop: [1199, 4],
          ...
          .data("navigationBtns", [
            "#latest-items-slider-prev",
            "#latest-items-slider-next"
          ]);
      var f = a(".purchased-items-slider.owl-carousel");
      b.checkSupport(f, a.fn.owlCarousel) &&
        f
          .owlCarousel({
            items: 4,
            itemsDesktop: [1199, 4],
      ...
      b.checkSupport(g, a.fn.owlCarousel) &&
        g
          .owlCarousel({
            items: 4,
            itemsDesktop: [1199, 4],
      ...
      b.checkSupport(h, a.fn.owlCarousel) &&
        h
          .owlCarousel({
            items: 4,
            itemsDesktop: [1199, 4],
        ...
        b.checkSupport(a(".owl-carousel"), a.fn.owlCarousel) &&
    ...
    flexsliders: function() {
      a.fn.flexslider &&
        (a(".category-image-slider.flexslider").flexslider({
          animation: "slide",
          animationLoop: !0,
          prevText: "",
          nextText: "",
    ...
    selectBox: function() {
      a.fn.selectbox &&
        a(".selectbox").selectbox({ effect: "fade", onChange: function() {} });
    },
    ...
    progressBars: function() {
      a.fn.appear
        ? (a(".progress-animate").appear(),
          a(".progress-animate").on("appear", function() {
            var b = a(this),
              c = a(this).data("width"),
    ...
    flickerFeed: function() {
      a.fn.jflickrfeed &&
        a("ul.flickr-feed-list").jflickrfeed(
          {
            limit: 6,
            qstrings: { id: "52617155@N08" },
            itemTemplate:
              '<li><a data-rel="prettyPhoto[gallery-flickr]" href="{{image}}" title="{{title}}"><img src="{{image_s}}" alt="{{title}}" /></a></li>'
          },
          function() {
            a.fn.prettyPhoto &&
              a("a[data-rel^='prettyPhoto']").prettyPhoto({
    ...
    calculateWidth: function() {
      ...
      b >= 4 && f.hasClass("wide")
        ? (this.container.find(".wide").css("width", 2 * Math.floor(d / b)),
          f.not(".wide").css("width", Math.floor(d / b)))
        : f.css("width", Math.floor(d / b));
    },
    ...
    isotopeReinit: function() {
      a.fn.isotope &&
        (this.container.isotope("destroy"), this.isotopeActivate());
    },
  ...
  b.init(),
    ...
    a.event.special.debouncedresize
      ? a(window).on("debouncedresize", function() {
          b.fixfilterScrollBar(),
            b.stickyMenu(),
            b.fixNavContainerHeight(),
            b.calculateWidth(),
            b.isotopeReinit(),
            b.firefoxMenuFix(),
            b.itemSizeFix();
  ...
  (function() {
    "use strict";
    function a() {
      var a = new google.maps.LatLng(51.520068, -0.156299),
        b = {
          center: a,
          zoom: 15,
          scrollwheel: !1,
  ...
  (function(a) {
    function b(a) {
      var b,
        ...
        d = i.attr("href");
      -1 == d.indexOf(a) && ((b = d + "" + c), i.attr("href", b));
    }
    ...
    a("#option-panel-btn").on("click", function() {
      ...
      a('a[data-toggle="tab"]').on("shown.bs.tab", function(b) {
        ...
        a("#option-panel-title")
          .find("span")
          .text(c);
      });
    var g = a("#custom-style");
    if (
      (a("#option-panel-reset").on("click", function(b) {
        "undefined" != typeof a.cookie("layoutMode") &&
          a.removeCookie("layoutMode"),
          "undefined" != typeof a.cookie("bgPattern") &&
            a.removeCookie("bgPattern"),
          "undefined" != typeof a.cookie("bgColor") &&
            a.removeCookie("bgColor"),
          "undefined" != typeof a.cookie("firstColor") &&
            a.removeCookie("firstColor"),
          "undefined" != typeof a.cookie("firstColor2") &&
            a.removeCookie("firstColor2"),
          "undefined" != typeof a.cookie("secondColor") &&
            a.removeCookie("secondColor"),
          "undefined" != typeof a.cookie("thirdColor") &&
            a.removeCookie("thirdColor"),
          "undefined" != typeof a.cookie("fourthColor") &&
            a.removeCookie("fourthColor"),
          "undefined" != typeof a.cookie("bgColor") &&
            a.removeCookie("bgColor"),
          "undefined" != typeof a.cookie("first-font") &&
            a.removeCookie("first-font"),
          "undefined" != typeof a.cookie("second-font") &&
            a.removeCookie("second-font"),
          "undefined" != typeof a.cookie("third-font") &&
            a.removeCookie("third-font"),
          "undefined" != typeof a.cookie("fourth-font") &&
            a.removeCookie("fourth-font"),
          location.reload(),
          b.preventDefault();
      }),
      "undefined" == typeof a.cookie("layoutMode") ||
        a("#wrapper").hasClass("boxed") ||
        a("#wrapper").addClass("boxed"),
      "undefined" != typeof a.cookie("bgPattern") &&
        a("body").css(
          "background",
          "url(" + a.cookie("bgPattern") + ") repeat"
        ),
      "undefined" != typeof a.cookie("bgColor") &&
        a("body").css("background", a.cookie("bgColor")),
      "undefined" != typeof a.cookie("firstColor") ||
        "undefined" != typeof a.cookie("firstColor2") ||
        "undefined" != typeof a.cookie("secondColor") ||
        "undefined" != typeof a.cookie("thirdColor") ||
      ...
      var h;
      "undefined" != typeof a.cookie("firstColor") &&
        (h += a.cookie("firstColor")),
        "undefined" != typeof a.cookie("firstColor2") &&
          (h += a.cookie("firstColor2")),
        "undefined" != typeof a.cookie("secondColor") &&
          (h += a.cookie("secondColor")),
        "undefined" != typeof a.cookie("thirdColor") &&
          (h += a.cookie("thirdColor")),
        "undefined" != typeof a.cookie("fourthColor") &&
          (h += a.cookie("fourthColor")),
        g.text(h);
    }
    a.fn.colpick &&
      (a("#panel-color-picker")
        .colpick({
          flat: !0,
          layout: "hex",
          submit: 0,
        ...
        .mouseup(function() {
          if (
            (a.cookie("bgPattern") && a.removeCookie("bgPattern"),
            a("#wrapper").hasClass("boxed") && a.cookie("layoutMode", "boxed"))
          ) {
      ...
      a(".color-box.third-color").colpick({
        ...
        onSubmit: function(b, c, d, e) {
          var f =
              ".discount-rect, .category-image-slider-container .discount-rect,#option-panel .colorbox-list li .third-color span { background-color : #" +
              c +
              ";}",
            h = g.text();
          g.text(h + " " + f),
            a.cookie("thirdColor", f),
            a(e)
              .find("span")
              .css("background-color", "#" + c),
            a(e).colpickHide();
      ...
      a(".color-box.fourth-color").colpick({
        ...
        onSubmit: function(b, c, d, e) {
          var f =
            ".dropdown-cart  .dropdown-cart-product-list  .dropdown-cart-details .item-price  { color: #" +
            c +
            ";}";
          (f +=
            "#option-panel .colorbox-list li .fourth-color span, #option-panel-title, .contact-details-list .contact-details-icon, .item-price-container, .contact-details-list .contact-details-icon { background-color : #" +
            c +
            ";}"),
            (f +=
              "#option-panel-tabs-container li.active a:after { border-top-color : #" +
              c +
              ";}");
          var h = g.text();
          g.text(h + " " + f),
            a.cookie("fourthColor", f),
            a(e)
              .find("span")
              .css("background-color", "#" + c),
            a(e).colpickHide();
