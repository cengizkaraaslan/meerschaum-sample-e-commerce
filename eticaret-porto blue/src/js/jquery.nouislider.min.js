(function(f) {
  ...
  f.fn.noUiSlider = function(C, D) {
    ...
    function x(a, b) {
      ...
      1 < c.length &&
        (a[0] !== c[0][0]
          ? (e = u(c[0].data("pct") + d.margin))
          : (k = u(c[1].data("pct") - d.margin)));
    ...
    function B(a, b, c) {
      ...
      a.cursor &&
        (y.css("cursor", f(a.target).css("cursor")),
        1 < b.a.length && b.target.addClass(g[20]),
        y.on("selectstart" + h, function() {
          return !1;
        }));
    }
    function O(a, b, c) {
      ...
      a.stopPropagation();
      c.orientation
        ? ((a = a.pointY), (e = b.height()))
        : ((a = a.pointX), (e = b.width()));
      d = b.data("handles");
      var k = a,
        m = c.style;
      1 === d.length
        ? (d = d[0])
        : ((m = d[0].offset()[m] + d[1].offset()[m]),
          (d = d[k < m / 2 ? 0 : 1]));
      ...
      f.each(
        {
          ...
          serialization: {
            ...
            t: function(a, b, c) {
              return (
                d.g(a.to, b, c) && d.f(a.resolution, b) && d.e(a.mark, b, c)
              );
            }
          },
          slide: {
    ...
    function R(a) {
      this.data("options", f.extend(!0, {}, a));
      a = f.extend(
        {
          handles: 2,
          margin: 0,
      ...
      return this.each(function() {
        ...
        b.data("base", k).addClass(
          [g[6], g[16 + a.direction], g[10 + a.orientation]].join(" ")
        );
        for (c = 0; c < a.handles; c++)
          (e = f("<div><div/></div>").appendTo(k)),
            e.addClass(g[1]),
            e
              .children()
              .addClass(
            ...
            e.data({ store: K(e, c, a.serialization) }),
            d.push(e);
        switch (a.connect) {
          case 1:
            b.addClass(g[9]);
        ...
        if (!a.behaviour.fixed)
          for (c = 0; c < d.length; c++)
            p(q.start, d[c].children(), B, { b: k, target: b, a: [d[c]] });
        a.behaviour.tap && p(q.start, k, O, { b: k, target: b });
        a.behaviour.extend &&
          (b.addClass(g[19]),
          a.behaviour.tap && p(q.start, b, P, { b: k, target: b }));
        a.behaviour.drag &&
          ((c = k.find("." + g[9]).addClass(g[18])),
          a.behaviour.fixed &&
            (c = c.add(
              k
                .children()
          ...
          p(q.start, c, B, { b: k, target: b, a: d }));
      });
    }
    function S() {
    ...
    function V(a) {
      return this.each(function() {
        ...
        a &&
          (f(this).noUiSlider(d),
          !1 !== b && d.start === c.start && f(this).val(b));
      });
    }
    var z = f(document),
      y = f("body"),
