              ...
              class: (function(t) {
                return function() {
                  ...
                  return (
                    ...
                    t.options.animate &&
                      e.push("" + t.options.baseClass + "-animate"),
                    t.options.disabled &&
        ...
        return (
          ...
          (t.prototype.size = function(t) {
            return "undefined" == typeof t
              ...
              : (null != this.options.size &&
                ...
                t &&
                  this.$wrapper.addClass("" + this.options.baseClass + "-" + t),
                (this.options.size = t),
                this.$element);
          }),
          (t.prototype.animate = function(t) {
            return "undefined" == typeof t
              ...
              : ((t = !!t),
                this.$wrapper[t ? "addClass" : "removeClass"](
                  "" + this.options.baseClass + "-animate"
                ),
          ...
          (t.prototype.disabled = function(t) {
            return "undefined" == typeof t
              ...
              : ((t = !!t),
                this.$wrapper[t ? "addClass" : "removeClass"](
                  "" + this.options.baseClass + "-disabled"
                ),
          ...
          (t.prototype.readonly = function(t) {
            return "undefined" == typeof t
              ...
              : ((t = !!t),
                this.$wrapper[t ? "addClass" : "removeClass"](
                  "" + this.options.baseClass + "-readonly"
                ),
                this.$element.prop("readonly", t),
                (this.options.readonly = t),
                this.$element);
          }),
          ...
          (t.prototype.indeterminate = function(t) {
            return "undefined" == typeof t
              ...
              : ((t = !!t),
                ...
                this.$element.prop("indeterminate", t),
                (this.options.indeterminate = t),
                this.$element);
          }),
          ...
          (t.prototype.onText = function(t) {
            return "undefined" == typeof t
              ? this.options.onText
              : (this.$on.html(t), (this.options.onText = t), this.$element);
          }),
          (t.prototype.offText = function(t) {
            return "undefined" == typeof t
              ? this.options.offText
              : (this.$off.html(t), (this.options.offText = t), this.$element);
          }),
            ...
            return (
              this.$on.on(
                ...
                (function(t) {
                  return function() {
                    return (
                      t.state(!1), t.$element.trigger("focus.bootstrapSwitch")
                    );
                  };
                })(this)
              ),
              this.$off.on(
                ...
                (function(t) {
                  return function() {
                    return (
                      t.state(!0), t.$element.trigger("focus.bootstrapSwitch")
                    );
                  };
                })(this)
              )
                ...
                return function(e) {
                  ...
                  if (t.isLabelDragging)
                    return (
                      e.preventDefault(),
                      (t.isLabelDragged = !0),
                      (o = e.pageX || e.originalEvent.touches[0].pageX),
                      (n =
                        ((o - t.$wrapper.offset().left) / t.$wrapper.width()) *
                        100),
                      (s = 25),
                      (i = 75),
                      t.options.animate &&
                      ...
                      s > n ? (n = s) : n > i && (n = i),
                      t.$container.css("margin-left", "" + (n - i) + "%"),
                  ...
                  return t.isLabelDragging
                    ? (e.preventDefault(),
                      t.isLabelDragged
                        ? ((t.isLabelDragged = !1),
                          t.state(
                            parseInt(t.$container.css("margin-left"), 10) >
                              -(t.$container.width() / 6)
                          ),
                          t.options.animate &&
                            t.$wrapper.addClass(
