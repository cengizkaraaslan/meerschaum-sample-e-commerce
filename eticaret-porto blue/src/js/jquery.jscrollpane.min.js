      ...
      function f(b) {
        ...
        if (((P = b), Q === c))
          ...
          (ub = U),
            Q.css("width", ""),
            d.width(R),
            T.find(">.jspVerticalBar,>.jspHorizontalBar")
              .remove()
              .end();
        }
        Q.css("overflow", "auto"),
      ...
      function k() {
        if (Z && Y) {
          ...
          (hb -= b),
            ...
            mb
              .parent()
              .append(a('<div class="jspCorner" />').css("width", b + "px")),
            h(),
            j();
        }
        ...
        p(),
          Y &&
            fb.bind("mousedown.jsp", function(b) {
              if (
                b.originalTarget === c ||
                b.originalTarget == b.currentTarget
              ) {
                var d,
                  e = a(this),
                  f = e.offset(),
        ...
        Z && f.push(lb[0]),
          ...
          d
            ...
            .bind("keydown.jsp", function(d) {
              if (
                d.target === this ||
                (f.length && a(d.target).closest(f).length)
              ) {
                var g = db,
                  h = ab;
                switch (d.keyCode) {
          ...
          P.hideFocus
            ? (d.css("outline", "none"),
              "hideFocus" in T[0] && d.attr("hideFocus", !0))
            : (d.css("outline", ""),
          ...
          .bind("touchmove.jsp", function(g) {
            if (f) {
              ...
              return (
                ...
                (e =
                  e || Math.abs(c - h.pageX) > 5 || Math.abs(d - h.pageY) > 5),
                i == db && j == ab
              );
            }
          })
